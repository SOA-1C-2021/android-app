...
public class AuthActivity extends AppCompatActivity {
    ...
    private Snackbar incorrectPatternSnackbar = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // create snackbar
        incorrectPatternSnackbar = Snackbar.make(findViewById(android.R.id.content).getRootView(), "Patrón incorrecto", Snackbar.LENGTH_SHORT);
